...
{% tab title="CWC" %}
Voting participants are each Steering[ CWC](../../foundation/committees-and-their-roles/bylaws-open-council/steering-council/project-cwcs/) member or each [Independent CWC](../../foundation/bylaws-cwc/core-working-committee/independent-cwcs.md) member.
{% endtab %}
